...
declare namespace model {
    class Board {
        ...
        private START_FIELD_NUMBER;
        private JAIL_FIELD_NUMBER;
        private _fields;
        constructor();
...
declare namespace model {
    ...
    class Pawn {
        private _color;
        constructor(_color: PawnColor);
        color: PawnColor;
    }
}
declare namespace model.player {
    enum PlayerStatus {
        NOT_READY = 0,
        READY = 1,
        ACTIVE = 2,
    ...
    class Player {
        private _name;
        private _status;
        constructor(_name: string, _status?: PlayerStatus);
        name: string;
        status: PlayerStatus;
        isReadyToPlay(): void;
        startsTurn(): void;
...
declare namespace model {
    ...
    class Model {
        private board;
        private pawnsPositions;
        private playersPawns;
        private players;
        private activePlayer;
        constructor();
        updateUserList(players: PlayersInfo): void;
        private newPlayerJoined(players);
        private findNewPlayers(players);
        private addNewPlayers(players);
        placeAllPawnsOnStart(): void;
        movePawn(movingPlayer: string, diceResult: number): void;
        updateTurn(activePlayer: string): void;
        gameStarted(): void;
    }
}
declare namespace protocols {
    const eventTitle: string;
    class UsernameChoice {
    ...
    class NewTurn {
        static message: string;
        static activePlayer: string;
    }
    class UsernamesObtained {
        static message: string;
        static info: string;
    }
    class OtherPlayerMoved {
        static message: string;
        static playerName: string;
        static movedBy: string;
    }
    class GameReset {
        static message: string;
    }
...
declare namespace events {
    const protocol: typeof protocols;
    enum EventType {
        TO_EXECUTE = 0,
        TO_SEND = 1,
    }
...
declare namespace events {
    class ServerEventFactory {
        ...
        private static chooseSubclass(title);
    }
...
declare namespace server {
    ...
    class SocketServer {
        ...
        addEventQueue(events: Queue<Event>): void;
...
declare namespace events {
    class UsernameChoiceEvent extends ClientEvent {
        constructor(name: string);
    }
    class RollDiceEvent extends ClientEvent {
        constructor();
    }
    class UserIsReadyEvent extends ClientEvent {
        constructor();
    }
}
declare namespace events {
    class UsernameValidationEvent extends ServerEvent {
        private valid;
        constructor();
        isValid: boolean;
    }
    class RollResultEvent extends ServerEvent {
        constructor();
        getResult(): any;
    }
    class NewTurnEvent extends ServerEvent {
        constructor();
        getActivePlayer(): any;
    }
    class UsernamesObtainedEvent extends ServerEvent {
        constructor();
        getUsernames(): Array<string>;
    }
    class OtherPlayerMovedEvent extends ServerEvent {
        constructor();
        getPlayerName(): any;
        movedBy(): any;
    }
    ...
    class GameResetEvent extends ServerEvent {
        constructor();
    }
}
declare namespace logic {
    class Controller {
        ...
        private sendToServer(event);
        private prepareHandlers();
        chooseName(name: string): void;
        rollDice(): void;
        playerIsReady(): void;
        private nameAccepted(event);
        private otherPlayersInfo(event);
        private gameStarts(event);
        private gameResets(event);
        private rolledValue(event);
        private someoneMoved(event);
        private newTurn(event);
    }
}
declare module View {
    class Pawn {
...
declare module View {
    class Board {
        ...
        movePawn(pawnNumber: number, fieldNumber: number, onMovingEnd: () => any): void;
    }
}
