...
(function (protocols) {
    ...
    protocols.UsernameChoice = UsernameChoice;
    ...
    protocols.UsernameValidation = UsernameValidation;
    ...
    protocols.UserIsReady = UserIsReady;
    ...
    protocols.RollDice = RollDice;
    var RollResult = (function () {
        function RollResult() {
        }
        Object.defineProperty(RollResult, "message", {
            get: function () {
                return 'rollResult';
            },
            enumerable: true,
        ...
        Object.defineProperty(RollResult, "result", {
            get: function () {
                return 'rollResult';
            },
            enumerable: true,
    ...
    protocols.RollResult = RollResult;
    var MyTurn = (function () {
        function MyTurn() {
        }
        Object.defineProperty(MyTurn, "message", {
            get: function () {
                return 'yourTurn';
            },
            enumerable: true,
    ...
    protocols.MyTurn = MyTurn;
    var PlayersConnected = (function () {
        function PlayersConnected() {
        }
        Object.defineProperty(PlayersConnected, "message", {
            get: function () {
                return 'userList';
            },
            enumerable: true,
        ...
        Object.defineProperty(PlayersConnected, "info", {
            get: function () {
                return 'userList';
            },
            enumerable: true,
    ...
    protocols.PlayersConnected = PlayersConnected;
    ...
    protocols.OtherPlayerMoved = OtherPlayerMoved;
...
(function (server) {
    var SocketServer = (function () {
        ...
        SocketServer.prototype.onMessage = function (event) {
            ...
            var eventToEnqueue = events.ServerEventFactory.createFrom(event.data);
...
(function (events) {
    ...
    var ServerEventFactory = (function () {
        function ServerEventFactory() {
        }
        ServerEventFactory.createFrom = function (event) {
            var fromServer = JSON.parse(event);
            var eventToEnqueue = this.chooseSubclass(fromServer['message']);
            for (var prop in fromServer) {
                if (prop !== 'message')
                    eventToEnqueue[prop] = fromServer[prop];
            }
            return eventToEnqueue;
        };
        ServerEventFactory.chooseSubclass = function (title) {
            switch (title) {
    ...
    events.ServerEventFactory = ServerEventFactory;
    var Event = (function () {
    ...
    events.ServerEvent = ServerEvent;
    var UsernameChoiceEvent = (function (_super) {
        __extends(UsernameChoiceEvent, _super);
        function UsernameChoiceEvent(name) {
            _super.call(this, prot.UsernameChoice.message);
            this[prot.UsernameChoice.name] = name;
        }
        return UsernameChoiceEvent;
    })(UserEvent);
    events.UsernameChoiceEvent = UsernameChoiceEvent;
    var UsernameValidationEvent = (function (_super) {
        __extends(UsernameValidationEvent, _super);
        function UsernameValidationEvent() {
            _super.call(this, prot.UsernameValidation.message);
        }
        Object.defineProperty(UsernameValidationEvent.prototype, "isValid", {
            get: function () {
                return this.valid;
            },
            enumerable: true,
        ...
        return UsernameValidationEvent;
    })(ServerEvent);
    events.UsernameValidationEvent = UsernameValidationEvent;
    var RollDiceEvent = (function (_super) {
        __extends(RollDiceEvent, _super);
        function RollDiceEvent() {
            _super.call(this, prot.RollDice.message);
        }
        return RollDiceEvent;
    })(UserEvent);
    events.RollDiceEvent = RollDiceEvent;
    var RollResultEvent = (function (_super) {
        __extends(RollResultEvent, _super);
        function RollResultEvent() {
            _super.call(this, prot.RollResult.message);
        }
        RollResultEvent.prototype.getResult = function () {
            return this[prot.RollResult.result];
        };
        return RollResultEvent;
    })(ServerEvent);
    events.RollResultEvent = RollResultEvent;
    var MyTurnEvent = (function (_super) {
        __extends(MyTurnEvent, _super);
        function MyTurnEvent() {
            _super.call(this, prot.MyTurn.message);
        }
        return MyTurnEvent;
    })(UserEvent);
    events.MyTurnEvent = MyTurnEvent;
    var UserIsReadyEvent = (function (_super) {
        __extends(UserIsReadyEvent, _super);
        function UserIsReadyEvent() {
            _super.call(this, prot.UserIsReady.message);
        }
        return UserIsReadyEvent;
    })(UserEvent);
    events.UserIsReadyEvent = UserIsReadyEvent;
    var PlayersConnectedEvent = (function (_super) {
        __extends(PlayersConnectedEvent, _super);
        function PlayersConnectedEvent() {
            _super.call(this, prot.PlayersConnected.message);
        }
        PlayersConnectedEvent.prototype.getUsersInfo = function () {
            return this[prot.PlayersConnected.info];
        };
        return PlayersConnectedEvent;
    })(ServerEvent);
    events.PlayersConnectedEvent = PlayersConnectedEvent;
    var OtherPlayerMovedEvent = (function (_super) {
        __extends(OtherPlayerMovedEvent, _super);
        function OtherPlayerMovedEvent() {
            _super.call(this, prot.OtherPlayerMoved.message);
        }
        OtherPlayerMovedEvent.prototype.getPlayerName = function () {
            return this[prot.OtherPlayerMoved.playerName];
        };
        OtherPlayerMovedEvent.prototype.movedBy = function () {
            return this[prot.OtherPlayerMoved.movedBy];
        };
        return OtherPlayerMovedEvent;
    })(ServerEvent);
    events.OtherPlayerMovedEvent = OtherPlayerMovedEvent;
    var GameStartEvent = (function (_super) {
        __extends(GameStartEvent, _super);
        function GameStartEvent() {
            _super.call(this, prot.GameStart.message);
        }
        return GameStartEvent;
    })(ServerEvent);
    events.GameStartEvent = GameStartEvent;
    var GameResetEvent = (function (_super) {
        __extends(GameResetEvent, _super);
        function GameResetEvent() {
            _super.call(this, prot.GameReset.message);
        }
        return GameResetEvent;
    })(ServerEvent);
    events.GameResetEvent = GameResetEvent;
})(events || (events = {}));
    ...
    var Controller = (function () {
        ...
        Controller.prototype.handleEvent = function (event) {
            if (event.type === EvType.TO_SEND) {
                ...
                var handler = this.handlers.getValue(event.title);
                handler(event);
            }
        };
